...
INSERT INTO `admin` VALUES (1,'admin','pbkdf2:sha256:50000$t1B4zFZd$b628f4506dd67f58e8f61571f0f07b27cbda33ad991676f90ab5308b7ff02a25'),(2,'mr','pbkdf2:sha256:50000$6eKyhd1Q$8951b6eee62f86f2d98cbcb72cdb389b9b94d9763eaf0cd16d66e4ef4dfedf20'),(3,'bnm','pbkdf2:sha256:50000$MSh1x51n$04a110b589ccad68c3591be5585b06378af2a9857363cb34fb0ca4740b9735f9');
...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE,
  KEY `ix_area_addtime` (`addtime`) USING BTREE
...
INSERT INTO `area` VALUES (1,'大学基础课程','2020-10-28 10:39:12',1,'与“专业课”相对，指高等学校和中等专业学校根据专业培养目标而开设的自然科学和人文社会科学基本理论、基本技能的课程。大学和中专的基础课的任务，是学生具有高等和中等专门人才的文化水平，为学习专业基础课和专业课打下基本理论和基本技能的基础。同一科类的各个专业，基础课程大致相同。为了达到专门人才的培养目标和基本要求，各专业的基础课都规定为必修课。为了提高教育质量，使学生具有适应科技迅速发展的能力，高等学校都十分重视加强基础课程的教学，选派经验丰富、水平较高的教师担任基础课教学工作。'),(2,'计算机科学与技术','2020-10-28 10:22:59',1,'主修大数据技术导论、数据采集与处理实践(Python ) 、Web前/后端开发、统计与数据分析、机器学习、高级数据库系统、数据可视化、云计算技术、人工智能、自然语言处理、媒体大数据案例分析、网络空间安全、计算机网络、数据结构、软件工程、操作系统等课程，以及大数据方向系列实验，并完成程序设计、数据分析、机器学习、数据可视化、大数据综合应用实践、专业实训和毕业设计等多种实践环节。\r\n'),(3,'软件工程','2020-10-10 09:31:59',1,'软件工程专业，暂无简介');
...
CREATE TABLE `collect` (
  ...
  `addtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `ix_collect_addtime` (`addtime`) USING BTREE,
...
INSERT INTO `collect` VALUES (3,1,7,'2018-08-13 09:25:14'),(6,1,8,'2020-10-28 13:10:38'),(7,8,9,'2020-10-28 14:48:10');
...
CREATE TABLE `scenic` (
  ...
  KEY `ix_scenic_addtime` (`addtime`) USING BTREE,
...
CREATE TABLE `suggestion` (
  ...
  `addtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `ix_suggestion_addtime` (`addtime`) USING BTREE
...
INSERT INTO `suggestion` VALUES (1,'andy','andy@qq.com','haha','2020-03-22 14:56:05'),(2,'andy','andy@qq.com','haha','2020-03-22 14:58:57'),(3,'andy','andy@qq.com','haha','2020-03-22 14:59:55'),(4,'andy','andy@qq.com','haha','2020-03-22 14:59:59'),(5,'andy','andy@qq.com','haha','2020-03-22 15:00:03'),(6,'andy','andy@qq.com','haha','2020-03-22 15:00:43'),(7,'andy','andy@qq.com','haha','2020-03-22 15:00:48'),(8,'andy','andy@qq.com','haha','2020-03-22 15:01:12'),(9,'love','wty5201314@qhy.com','our story no end','2020-05-20 13:14:00');
...
CREATE TABLE `travels` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `title` (`title`) USING BTREE,
  KEY `ix_travels_addtime` (`addtime`) USING BTREE,
  KEY `scenic_id` (`scenic_id`) USING BTREE
...
INSERT INTO `user` VALUES (4,'pbkdf2:sha256:50000$TkExX9Jm$d63477853a17dcaedcd52be4b6213ebb74b61a12456762ac19d6b7dfb559aa57','andy@mrsoft.com','2018-03-23 14:26:12',NULL,NULL,NULL,'Andy',NULL),(5,'pbkdf2:sha256:50000$qFfVpeJK$9bc7ff46019ff211c31081e016d42770be6fae4df99e2f8d386ebd00e852ebda','zhangsan@qq.com','2018-08-10 10:50:34',NULL,NULL,NULL,'张三',NULL),(7,'pbkdf2:sha256:50000$sSujvFmg$0958ae9e146e41e1301d38c55d424fe9c1fae98c0843e84234fefe1aab1a7d38','lisi@qq.com','2018-08-10 16:10:13',NULL,NULL,NULL,'李四',NULL),(8,'pbkdf2:sha256:50000$hgnE4S9B$ff3c6c5b5de51af60bc139692a12b20277419228e79b98e2eefe344e7a494a32','1235@136.com','2020-10-28 11:17:35',NULL,NULL,'12345678901','aaa',0),(9,'pbkdf2:sha256:50000$M6JYPeZr$9f3229730650f0c563b16cc3f8a4a4aa45ff35b06d6351e03696405aceb445d2','123455@qq.com','2020-10-28 13:11:09',NULL,NULL,'123456711','duhas',0);
...
-- Dump completed on 2021-02-27 13:51:36
